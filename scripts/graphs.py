...
graphs = [
    # Social Graphs
    ('com-orkut_sym', 'https://www.dropbox.com/s/2okcj8q7q1z3nkw/com-orkut_sym.bin?dl=0'),
    ('soc-LiveJournal1_sym', 'https://www.dropbox.com/s/6pbryf0wpxgmj7c/soc-LiveJournal1_sym.bin?dl=0'),
